...
class AdSense {
  ...
  AdListener _adListener = AdListener(
    ...
    onAdFailedToLoad: (ad, error)=> print('Add error: ${ad.adUnitId}, the error: $error'),
    ...
    onRewardedAdUserEarnedReward: (ad, reward)=> print('Ad reward ad user: ${ad.adUnitId}, ${reward.amount}, ${reward.type}'),
  );
}
