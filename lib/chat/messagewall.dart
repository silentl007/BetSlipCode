...
class MessageWall extends StatelessWidget {
  ...
  _send(int lastItem) {
    print('from outside function ==> $lastItem');
    itemScrollController.jumpTo(index: lastItem, alignment: 0);
    // if (_message == null || _message.isEmpty) {
    // } else {
    //   _addMessage(_message);
    //   _message = '';
    //   _controller.clear();
    //   itemScrollController.jumpTo(index: lastItem);
    // }
  }
